...
const Mobile = () => {
  ...
  return (
    <div className="relative lg:hidden">
      <button
        className="g-neutral-400/10 hover:bg-neutral-500/10 border border-teal-600/40 text-neutral-50 p-2 rounded-lg text-center cursor-pointer hover:border-teal-500/40 duration-200 ease-in-out"
        ref={btnRef}
        onClick={() => {
          setIsOpen(!isOpen);
        }}
